$(function() {
    ...
    if ( e(), $("#c_logos .slide, .logo-slider").owlCarousel({
        loop: !0,
        margin: 10,
        nav: !1,
        autoplay: !0,
    ...
    $(".mh").matchHeight();
    var c = $("#modal-bg"),
        u = $("#modal-bg #modal, .exit"),
        m = $("body");
    $("a.start-project").on("click", function() {
        return c.addClass("appear"), m.addClass("modal-open"), setTimeout(function() {
            u.addClass("pop")
        }, 300), !1
    }), $("#modal-bg .exit").on("click", function() {
        return c.removeClass("appear"), u.removeClass("pop"), m.removeClass("modal-open"), !1
    });
    var p = $("#search-modal"),
