                    ...
                    <div class="breadcumb--con">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{ isset($business_category->title) ? $business_category->title : 'Category Unknown' }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <section class="uza-portfolio-area">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 title">
                ...
                <h2>{{ isset($business_category->title) ? $business_category->title : 'Category Unknown' }}</h2>
                ...
                @foreach($businesses AS $k => $business)
                    @if($business->member->member_type_id == "Platinum Membership")
                        <div class="job clickable">
                            ...
                            <a href="{{ url('members/business/' . $business->slug ) }}" class="uza-btn btn-2">More information</a>
