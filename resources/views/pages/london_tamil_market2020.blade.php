...
@section('content')
    ...
    <section class="halfarea">
        <div class="col-md-6 col-sm-3 imagearea" style="height: 540px;">
            <iframe class="center-block" src="https://www.youtube.com/embed/1zpQNBGefWM" width="560" height="315" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allowFullScreen="true"></iframe>
        </div>
        <div class="container" style="height: 540px;">
            <div class="row">
                <div class="col-md-5 col-sm-8 col-md-offset-7 col-sm-offset-4">
                    <h5>Visual Treat</h5>
                    <h2>Official Event</h2>
                </div>
            </div>
        </div>
    </section>
